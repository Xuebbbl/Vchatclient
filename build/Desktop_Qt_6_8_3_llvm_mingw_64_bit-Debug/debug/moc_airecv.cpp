/****************************************************************************
** Meta object code from reading C++ file 'airecv.h'
**
...
#error "The header file 'airecv.h' doesn't include <QObject>."
...
void ApiHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->reciveString((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ApiHandler::*)(QString );
            if (_q_method_type _q_method = &ApiHandler::reciveString; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ApiHandler::reciveString(QString _t1)
{
